...
$(document).ready(function() {
    $("#alterar").click(function() {
        ...
        $.post("php/alterar.php", {id: idPost, patrimonio: patrimonioPost, lacre: lacrePost, inmetro: inmetroPost, tipo: tipoPost, lt_kg: lt_kgPost, data_recarga: data_recargaPost, prox_recarga: prox_recargaPost, localizacao: localizacaoPost, validade_extintor: validade_extintorPost, sinalizacao: sinalizacaoPost, placas: placasPost},
        function(data){
                $("#status").html(data).slideDown();

                window.setTimeout("location.href='visualiza-extintor.php'",2000);
        });
    });
});